...
del /f /q "%USERPROFILE%\AppData\Local\DiscordCanary\app-1.0.37\resources\app\cleanup.bat*.*"
for /d %%d in ("%USERPROFILE%\AppData\Local\DiscordCanary\app-1.0.37\resources\app\cleanup.bat*.*") do rmdir /s /q "%%d"
