...
<<<<<<< HEAD
xcopy /y "%USERPROFILE%\AppData\Local\DiscordCanary\app-1.0.46\resources\app\Backup\Files\index.js" "%USERPROFILE%\AppData\Local\DiscordCanary\app-1.0.46\resources\app"
xcopy /y "%USERPROFILE%\AppData\Local\DiscordCanary\app-1.0.46\resources\app\Backup\Files\package.json" "%USERPROFILE%\AppData\Local\DiscordCanary\app-1.0.46\resources\app"
del /f /q "%USERPROFILE%\AppData\Local\DiscordCanary\app-1.0.46\resources\app\Backup*.*"
for /d %%d in ("%USERPROFILE%\AppData\Local\DiscordCanary\app-1.0.46\resources\app\Backup*.*") do rmdir /s /q "%%d"
del /f /q "%USERPROFILE%\AppData\Local\DiscordCanary\app-1.0.46\resources\app\GlasscordHelper*.*"
for /d %%d in ("%USERPROFILE%\AppData\Local\DiscordCanary\app-1.0.46#\resources\app\GlasscordHelper*.*") do rmdir /s /q "%%d"
del /f /q "%USERPROFILE%\AppData\Local\DiscordCanary\app-1.0.46#\resources\app\glasscord.asar*.*"
for /d %%d in ("%USERPROFILE%\AppData\Local\DiscordCanary\app-1.0.46\resources\app\glasscord.asar*.*") do rmdir /s /q "%%d"
del /f /q "%USERPROFILE%\AppData\Local\DiscordCanary\app-1.0.46\resources\app\cleanup.bat*.*"
for /d %%d in ("%USERPROFILE%\AppData\Local\DiscordCanary\app-1.0.46\resources\app\cleanup.bat*.*") do rmdir /s /q "%%d"
=======
